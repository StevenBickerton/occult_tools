...
my $other = join(" ", @other);
system("plot $statfile [:] [-500:] 3d u2:4:'(\$10>$snr_ref?\$10:1/0)':'(2.0)' u2:4:'(\$10<$snr_ref?\$10:1/0)':'(1.5)' w p pt 7 ps variable palette set:view=map sett:xlabel=\'radius (m)\' sett:ylabel=\'Im. Par. (m)\' unset:key $other");
