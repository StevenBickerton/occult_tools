...
int main(int argc, char *argv[])
{
  ...
  for (file_i=0; file_i<Nfresfiles; file_i++) {
    ...
    offset = pfresPatt[0]->maxOffset * ( (FLOAT) rand()/RAND_MAX);
    ...
    if (file_i == 0) {
      ...
      fprintf (fp, "# \n");
      fprintf (fp, "# No.  Index  time   rad   AU   offset\n");
    }
